* cpputils-cmake.el (current version 0.3.3)
...
- It's lightweight. It only cost me one line code to add a fancy feature. How could extra one line code make cpputils-cmake more heavy weight? Besides, I am C developer with more than ten years experience, so I may be qualified avoid my
