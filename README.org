* cpputils-cmake.el (version 0.4.9)
...
Please note you need make sure CMakeLists.txt is at the same level with c/cpp files. This limitation will be removed in next version.
...
** flymake
Open C++ file. Run "M-x flymake-mode". Please note all commands are availble *ONLY when you editing/debugging C/C++ code!*
